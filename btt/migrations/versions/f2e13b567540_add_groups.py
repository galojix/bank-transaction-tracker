...
def downgrade():
    ...
    op.create_foreign_key(
        "transactions_id_fkey", "transactions", "users", ["id"], ["id"]
    )
    op.drop_column("transactions", "group_id")
    op.add_column(
        "categories", sa.Column("id", sa.INTEGER(), autoincrement=False, nullable=True)
    )
    op.drop_constraint(None, "categories", type_="foreignkey")
    op.create_foreign_key("categories_id_fkey", "categories", "users", ["id"], ["id"])
    op.drop_column("categories", "group_id")
    op.add_column(
        "accounts", sa.Column("id", sa.INTEGER(), autoincrement=False, nullable=True)
    )
